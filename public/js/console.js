(function() {
    ...
    var consoleFrame,
        ...
        codeToPaste = '<script type="application/x-javascript" src="http://' + host + '/' + channelName + '/debug.js"></script>',
        socket;
    ...
    window.command = function(data) {
        logRow([data.message], data.className);
    };
